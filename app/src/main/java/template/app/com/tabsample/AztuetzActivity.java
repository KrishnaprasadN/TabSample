...
public class AztuetzActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_astuez_tab);
    ...
    private void initViews() {
        ...
        tabStrip.setDividerColor(R.color.primary_material_dark);
